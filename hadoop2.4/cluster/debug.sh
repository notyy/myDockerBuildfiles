...
docker run --name=namenode -d -h=namenode -p 50070:50070 notyy/hadoop-master:2.4.1

docker run --name=namenode -ti -h=namenode -p 50070:50070 notyy/hadoop-master:2.4.1 /etc/bootstrap.sh -bash
